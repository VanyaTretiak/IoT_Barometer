...
public class TemperatureChartMonth implements Initializable {
    @FXML
    ...
    //Function to initialize TemperatureChart
    @FXML
    ...
    public void updateChart() {
        ...
        for (int i = 0; i < 30; i++){
            if (i + 1 <= max){
                XYChart.Data<Integer, Double> dataPoint = new XYChart.Data<>(i + 1, lastItems.get(i).getTemperature());
